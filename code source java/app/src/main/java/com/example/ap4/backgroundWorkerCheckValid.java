...
public class backgroundWorkerCheckValid extends AsyncTask<String, Void, String> {
    Context context;
    AlertDialog alertDialog;
    backgroundWorkerCheckValid(Context context) {
    ...
    protected void onPostExecute(String result) {
        alertDialog.setTitle("Validation de l'essaim");
